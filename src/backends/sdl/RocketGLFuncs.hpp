...
/*
 * GL functions done in the style of SDL2
 * All of these definitions are copied from SDL2's SDL_glfuncs.h, SDL_glesfuncs.h and SDLgles2funcs.h
 */
...
SDL_PROC_UNUSED(void, glDrawTexiOES, (GLint, GLint, GLint, GLint, GLint))
SDL_PROC(void, glEnable, (GLenum))
SDL_PROC(void, glEnableClientState, (GLenum))
SDL_PROC(void, glFinish, (void))
SDL_PROC_UNUSED(void, glGenFramebuffersOES, (GLsizei, GLuint *))
...
SDL_PROC_UNUSED(void, glBindFramebufferOES, (GLenum, GLuint))
SDL_PROC_UNUSED(void, glFramebufferTexture2DOES, (GLenum, GLenum, GLenum, GLuint, GLint))
SDL_PROC_UNUSED(GLenum, glCheckFramebufferStatusOES, (GLenum))
SDL_PROC(void, glPushMatrix, (void))
SDL_PROC(void, glTranslatef, (GLfloat, GLfloat, GLfloat))
SDL_PROC(void, glRotatef, (GLfloat, GLfloat, GLfloat, GLfloat))
SDL_PROC(void, glPopMatrix, (void))
SDL_PROC_UNUSED(void, glDeleteFramebuffersOES, (GLsizei, const GLuint*))
